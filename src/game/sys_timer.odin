...
timer_create :: proc(frames: int, on_complete: proc(w: ^World, entity: int, data: rawptr) = nil) -> Timer {
...
timer_create_with_update :: proc(
	...
	return Timer{frames = frames, on_update = on_update, on_complete = on_complete, delete_on_complete = true}
}
